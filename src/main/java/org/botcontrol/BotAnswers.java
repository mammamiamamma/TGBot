...
public class BotAnswers {
    ...
    enum AnswerOptions{
        GREET, CONNUM, CONNUM_ERROR, CONNUM_ACCEPTED, USERNAME_NOT_VISIBLE, SUB_OPTION_3, SUB_OPTION_6, SUB_OPTION_12
    }
    public String getAnswer(AnswerOptions answerOptions){
